...
type Config struct {
	...
	HetznerOSAccessKey string
	HetznerOSSecretKey string
	HetznerOSBucket    string
	HetznerOSEndpoint  string
...
func Load() Config {
	return Config{
		...
		HetznerOSAccessKey: getEnv("HETZNER_OS_ACCESS_KEY", ""),
		HetznerOSSecretKey: getEnv("HETZNER_OS_SECRET_KEY", ""),
		HetznerOSBucket:    getEnv("HETZNER_OS_BUCKET", "retainr-pdfs"),
		HetznerOSEndpoint:  getEnv("HETZNER_OS_ENDPOINT", "https://fsn1.your-objectstorage.com"),
